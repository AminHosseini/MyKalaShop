namespace ShopManagement.Infrastructure.Configuration.Permissions
{
    public static class ShopPermissions
    {
        ...
        public const int ListProductCategories = 111;
        public const int SearchProductCategories = 112;
        public const int CreateProductCategory = 113;
        public const int EditProductCategory = 114;

        public const int AccessToProducts = 120;
        public const int ListProducts = 121;
        public const int SearchProducts = 122;
        public const int CreateProduct = 123;
        public const int EditProduct = 124;

        public const int AccessToProductPictures = 130;
        public const int ListProductPictures = 131;
