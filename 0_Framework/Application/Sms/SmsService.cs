...
namespace _0_Framework.Application.Sms
{
    public class SmsService : ISmsService
    {
        ...
        public void Send(string number, string message)
        {
            ...
            SmsIr smsIr = new SmsIr(smsSecrets["SecretKey"]);
            var bulkSendResult = smsIr.BulkSend(30007732006167, message, new string[] { number });
            if (bulkSendResult.Status == 200) return;
            //var verificationSendResult = smsIr.VerifySend("9120000000", 100000, new VerifySendParameter[] { new("Code", "12345") });
